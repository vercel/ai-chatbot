...
export async function POST(req: Request) {
  ...
  const classTypes: { [key: string]: string } = {
    free: '',
    restaurant: `Act as a waiter at a restaurant that specializes in several international cuisines. Ask the customer if they have any questions about the menu, explain how the dishes are prepared, and offer recommendations based on their tastes.
    The target vocabulary is: eaten, specialty, originates, grilled, stuffed, fresh, recommendation.`,
    tourist: `Act as someone who has never visited the city where your friend lives. Try to plan a trip to visit them, asking for advice about what to see and do.
    The target vocabulary is: sight, tourist attraction, famous, statue, national park, must-see, suggestion, cuisine, depends.`,
    invitations: `Act as a friendly colleague. If your coworker invites you to an event, ask for relevant further information and determine if you will be able to attend. If you can, then confirm the details and express excitement . If you cannot, then politely decline and express your regret.											
    The target vocabulary is: annual, attend, formal, informal, luncheon, invite, Would you like to.`,
    occasion: `Act as someone who is curious about their neighbor's upcoming plans for a special occasion. Ask what the occasion is and what they are doing to celebrate. Be friendly and ask relevant follow-up questions.

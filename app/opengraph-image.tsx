      ...
      <div tw="flex w-full items-start h-full flex-col bg-[#09090b] text-white p-[80px]">
        <div tw="flex flex-col w-full pt-[40px]">
          ...
          <div tw="flex w-full mt-14 items-start">
            ...
            <div tw="flex text-white opacity-80 font-bold text-4xl leading-normal ml-10">
              A Next.js 13 and App Router-ready AI chatbot template built using
              Vercel AI SDK and KV for storage...▍
            </div>
          </div>
        </div>

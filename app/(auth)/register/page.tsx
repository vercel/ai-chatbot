...
export default function Page() {
  ...
  useEffect(() => {
    if (state.status === "user_exists") {
      ...
      toast({
        type: "error",
        description: "Invalid data! Email must be valid and password at least 6 characters.",
      });
        ...
        <div className="hidden flex-1 flex-col justify-center pr-12 lg:flex">
          <div className="space-y-6">
            ...
            <div className="space-y-4 pl-2">
              <h2 className="font-semibold text-2xl">Join TiQology Today!</h2>
            ...
            <div className="space-y-6 rounded-3xl border border-border/50 bg-background/80 p-8 shadow-2xl backdrop-blur-xl">
              ...
              <div className="space-y-2 text-center">
                ...
                <p className="text-muted-foreground text-sm">
                  Sign up to get started with TiQology Nexus
                </p>
              </div>
              ...
              <div className="rounded-xl border border-purple-200 bg-gradient-to-br from-purple-50 to-pink-50 p-4 dark:border-purple-800 dark:from-purple-900/20 dark:to-pink-900/20">

			...
			<div className="max-w-4xl mx-auto">
				...
				<div className="text-center mb-12">
					...
					<p className="text-lg text-muted-foreground max-w-2xl mx-auto">
						...
						discuss your project and provide a personalized quote.
					</p>
				</div>
				...
				<div className="bg-card border rounded-2xl p-8 md:p-12 shadow-xl">
					<form onSubmit={handleSubmit} className="space-y-6">
						...
						<button
							...
							className="w-full rounded-lg bg-primary px-6 py-3 font-medium text-primary-foreground hover:bg-primary/90 transition-colors disabled:opacity-50"
						>

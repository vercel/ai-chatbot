...
You will need to use the environment variables [defined in `.env.example`](.env.example). Create a .env.local file and add the variables.
...
Your app template should now be running on [localhost:3000](http://localhost:3000/). Note: if you need to change the port, you can do so in the package.json file.

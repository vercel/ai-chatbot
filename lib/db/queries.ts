...
export async function createGuestUser() {
  ...
  console.log("[v0] Creating guest user with email:", email)
  console.log("[v0] Database URL exists:", !!process.env.POSTGRES_URL)
  ...
  try {
    ...
    console.log("[v0] Guest user created successfully:", result)
    return result
  } catch (error) {
    console.error("[v0] createGuestUser error details:", error)

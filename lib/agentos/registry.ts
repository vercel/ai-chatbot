...
export const AGENT_REGISTRY: Record<string, AgentDescriptor> = {
  "ghost-evaluator": {
    ...
    description:
      "AI-powered evaluation agent using Claude models for scoring and feedback",
  ...
  "best-interest-engine": {
    ...
    description:
      'Specialized family law agent for "Best Interest of the Child" evaluations',
    supportedKinds: ["evaluation"],
  ...
  "devin-builder": {
    ...
    description:
      "Human-in-the-loop development agent that generates Rocket–Devin task templates",
  ...
  "rocket-ops": {
    ...
    description:
      "Human-in-the-loop operations agent for deployment and infrastructure management",

...
export function AnimatedBeamMultipleInputDemo() {
  ...
  return (
    <div
      className="relative flex h-full w-full max-w-[32rem] items-center justify-center overflow-hidden bg-background p-10"
      ref={containerRef}
    >
...
const Icons = {
  googleDrive: (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve" width="300" height="500" viewBox="50 100 300 200" {...props}>
    <g transform="scale(1)">
        ...
        <div className="container z-10 flex flex-col">
          <div className="mt-4 sm:mt-10 md:mt-20 grid grid-cols-1">
            <div className="flex flex-col items-center gap-6 pb-8 text-center">
              ...
              >
                Our platform helps you deliver your content to your audience in a streamlined fashion that reduces subscriber churn and increases engagement through custom chatbots and other AI solutions. Contact us for a quote.
              </motion.p>

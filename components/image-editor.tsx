 ...
 * @version 1.2.0
 * @date 2025-06-07
 * @updated Сделаны пропсы, связанные с версионированием, опциональными.
 */

/** HISTORY:
 * v1.2.0 (2025-06-07): Пропсы `mode`, `isCurrentVersion` и другие сделаны необязательными.
 * v1.1.0 (2025-06-07): Реализован режим 'diff' со слайдером.
 * v1.0.0 (2025-06-07): Начальная версия с рендерингом по URL.
 */

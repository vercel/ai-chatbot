...
export const CopyIcon = ({ size = 10 }: { size?: number }) => (
  <svg
    height={size}
    strokeLinejoin="round"
    viewBox="0 0 18 20"
...
export const ThumbUpIcon = ({ size = 1 }: { size?: number }) => (
  <svg
    height={size}
    viewBox="0 0 18 20"
    width={size}
...
export const ThumbDownIcon = ({ size = 1 }: { size?: number }) => (
  <svg
    height={size}
    strokeLinejoin="round"
    viewBox="0 0 18 20"
...
export const ChevronDownIcon = ({ size = 3 }: { size?: number }) => (
  <svg
    height={size}
    strokeLinejoin="round"
    viewBox="0 0 16 16"
...
export function MicIcon({ size = 10 }: { size?: number }) {
  return (
    <svg
      width={size}
      height={size}

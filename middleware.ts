...
export async function middleware(request: NextRequest) {
  ...
  if (pathname.startsWith('/api/auth') || pathname.startsWith('/api/debug') || pathname.startsWith('/api/invitations/validate')) {
  ...
  if (!token) {
    ...
    // Redirect other pages to login for unauthenticated users

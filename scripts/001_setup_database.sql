-- Migration 0000: Create initial tables (User and Chat)
...
-- Migration 0001: Create Document and Suggestion tables
...
-- Migration 0002: Create Message and Vote tables, add title to Chat
...
ALTER TABLE "Chat" ADD COLUMN IF NOT EXISTS "title" text NOT NULL DEFAULT 'Untitled Chat';
...
-- Migration 0006: Create Stream table
...
-- Migration 0007: Add lastContext column to Chat
